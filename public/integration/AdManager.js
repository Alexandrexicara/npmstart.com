...
const AdManager = (function() {
     ...
     * Controla a frequência de exibição e registra a exibição para rastreamento de receita.
    ...
    function displayAd() {
        ...
        // Registra a exibição para rastreamento de receita (se ProfitTracker estiver disponível)
        if (typeof ProfitTracker !== 'undefined' && ProfitTracker.trackAdDisplay) {
            ProfitTracker.trackAdDisplay(adLink, 0.10); // R$0.10 por exibição
        }
