...
class Merchants extends APIResource {
    ...
    listPersons(merchantCode, query, params) {
        return this._client.get({
    ...
    getPerson(merchantCode, personId, query, params) {
        return this._client.get({
...
class Readers extends APIResource {
    ...
    createCheckout(merchantCode, readerId, body, params) {
        return this._client.post({
    ...
    terminateCheckout(merchantCode, readerId, body, params) {
        return this._client.post({
