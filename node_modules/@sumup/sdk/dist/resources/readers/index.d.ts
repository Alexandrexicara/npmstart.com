...
export declare class Readers extends Core.APIResource {
     ...
     *
     */
    createCheckout(merchantCode: string, readerId: string, body: CreateReaderCheckoutRequest, params?: Core.FetchParams): Core.APIPromise<CreateReaderCheckoutResponse>;
    /**
     ...
     *
     */
    terminateCheckout(merchantCode: string, readerId: string, body?: CreateReaderTerminateParams, params?: Core.FetchParams): Core.APIPromise<void>;
}
export declare namespace Readers {
    export type { CreateReaderCheckoutError, CreateReaderCheckoutRequest, CreateReaderCheckoutResponse, CreateReaderCheckoutUnprocessableEntity, CreateReaderParams, CreateReaderTerminateError, CreateReaderTerminateParams, CreateReaderTerminateUnprocessableEntity, Meta, Reader, ReaderDevice, ReaderID, ReaderName, ReaderPairingCode, ReaderStatus, UpdateReaderParams, };
}
